        ...
        <div className="group flex flex-col gap-2 sm:flex-row border-[#333333] border p-4 w-full max-w-md bg-black text-white m-auto my-5 rounded-lg shadow-xl hover:bg-[#8c71ff] hover:text-[#000000]">
          <div className="w-full sm:w-1/3 flex flex-col gap-2 items-center mb-4 sm:mb-0 justify-start">
            <Link
              ...
              className="h_image-container w-28 h-28 overflow-hidden rounded-sm"
            >
              <img
                src={image}
                alt={displayName}
            ...
            <div className="flex">
              ...
              {twitterInfo && twitterInfo.username ? (
                <Link
                  target="_blank"
                  href={`https://x.com/${twitterInfo?.username}`}
                  className="box1 right-trapezium w-[2rem] h-[2rem] p-[1px] bg-zinc-800 "
                >
                  <svg
              ...
              {/* discord */}
              {discordInfo && discordInfo.discordId ? (
                <Link
                  target="_blank"
                  href={`https://discord.com/channels/@me/${discordInfo?.discordId}`}
                  className="box1 left-right-trapezium w-[2rem] h-[2rem] p-[1px] bg-zinc-800"
                >
                  <svg
              ...
              {/* telegram */}
              {teleInfo && teleInfo.telegramId ? (
                <Link
                  target="_blank"
                  href={`https://web.telegram.org/a/#${teleInfo?.telegramId}`}
                  className="box1 left-trapezium w-[2rem] h-[2rem] p-[1px] bg-zinc-800"
                >
                  <svg
          ...
          <div className="w-full sm:w-2/3 flex flex-col sm:pl-4 p-2">
            <Link
              href={`/user/profile/${_id}`}
              className="text-sm font-bold text-start mr-7 mt-3 sm:text-left"
            >
              {displayName}
            </Link>
