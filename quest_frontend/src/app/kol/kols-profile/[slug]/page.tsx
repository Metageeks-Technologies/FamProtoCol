          ...
          <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            <div className="col-span-4 sm:col-span-3">
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="flex items-center justify-center space-x-4">
                  <button className="p-2 border rounded-full bg-green-400" onClick={() => setvotes(votes + 1)}>
                    <svg
                  ...
                  <span className="text-2xl font-bold text-black">{votes}</span>
                  <button className="p-2 border rounded-full bg-red-300" onClick={() => setvotes(votes - 1)}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6 text-black"
                      fill="none"
            ...
            <div className="col-span-4 sm:col-span-9">
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <h2 className="text-xl font-bold mt-6 mb-4 text-black">title</h2>
                <div className="mb-6">
