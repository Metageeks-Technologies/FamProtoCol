...
const CommunityDataPage = (props: Props) => {
  ...
  const renderCell = React.useCallback(
    (data: any, columnKey: React.Key, type: string) => {
            ...
            <div className="flex items-center justify-center">
              <div className="relative flex items-center gap-2">
                ...
                <Tooltip color="danger" content="Delete">
                  <button
                    onClick={() => handleDelete(type, data._id)}
  ...
  const handleAdd = async (e: any) => {
    ...
    try {
      ...
      if (res) {
        ...
        const response = await axios.post(
          `${process.env.NEXT_PUBLIC_SERVER_URL}/admin/addCommunityData`,
          {
  ...
  const handleUpdate = async (e: any) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/admin/metadata/${selectedData.type}/${selectedData._id}`,
        {
          ...newData,
        }
      );
  ...
  return (
    <div className="bg-slate-100 text-black h-screen overflow-y-scroll ">
      <div className="bg-white h-screen ">
        ...
        <div className="flex justify-between items-center gap-4 ">
              ...
              <TableBody  items={CategoryItems}>
                {(item: ICategory) => (
                  <TableRow key={item._id}>
                    {(columnKey) => (
                      <TableCell>
                        {renderCell(item, columnKey, "category")}
                      </TableCell>
                    )}
                  </TableRow>
                )}
          ...
          <div className="w-full  p-4">
            <div className="mb-2 flex justify-between items-center">
              <div className="font-bold text-xl">Ecosystems</div>
              <Button
                color="primary"
                onClick={() => handleModalOpen("ecosystem")}
              >
                Add Ecosystem
              </Button>
            </div>
              ...
              <TableBody items={EcosystemItems}>
                {(item: IEcosystem) => (
                  <TableRow key={item._id}>
                    {(columnKey) => (
                      <TableCell>
                        {renderCell(item, columnKey, "ecosystem")}
                      </TableCell>
                    )}
                  </TableRow>
                )}
                  ...
                  >
                    <div className="mb-4">
                      ...
                      <div className="flex justify-between items-center">
                        <div
                          {...getRootProps()}
                          className="w-32 border-2 border-gray-800 justify-center items-center text-black p-1 rounded-md"
                        >
